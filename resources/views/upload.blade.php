...
@section('content')
    <div id="main" class="container text-center">
        <div id="post_info">
            <img src="{{ asset($upload->path)}}" alt="Submission: {{ $upload->title }}" class="pb-4">
...
{{--        Make a comment--}}
        <div class="mb-3 pb-5">
            <form action="{{ route('post_comment') }}" METHOD="POST">
                ...
                <textarea class="form-control pb-2" id="message" name="message" maxlength="255" rows="3" required></textarea>
